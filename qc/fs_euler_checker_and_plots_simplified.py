...
unzip_temp_dir = Path(os.path.join(input_zip_dir,"temp"))
unzip_temp_dir.mkdir(exist_ok=True)
output_dir = Path(os.path.join(input_zip_dir,"csvs"))
output_dir.mkdir(exist_ok=True)
output_svg_dir = Path(os.path.join(input_zip_dir,"svg"))
...
# fix freesurfer multises unzip bug
unzipped = str(unzip_temp_dir / 'freesurfer' / subid.split('_ses')[0])
newdir = str(unzip_temp_dir / 'freesurfer' / subid)
os.rename(unzipped,newdir) 
