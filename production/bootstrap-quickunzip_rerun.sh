...
PROJECTROOT=/cbica/projects/rosmap_fmri/DERIVATIVES

cd ${PROJECTROOT}

XCPROOT=/cbica/projects/rosmap_fmri/production_rerun/xcp-multises   # input 1: path to your XCP bootstrap
...
datalad create -c yoda -D "extract xcp results" XCP_RERUN
cd XCP_RERUN
